package com.leetcode.L3201_3300.L3298;

public class RearrangedSubstringCounterIITest {
    public static void main(String[] args) {
        RearrangedSubstringCounterII rearrangedSubstringCounter = new RearrangedSubstringCounterII();
        /*
         * 示例 1：
