...
记录自己LeetCode每日刷题之旅（现有**1104**道，持续更新中...）
...
| 困难 | 堆 | 数组、堆、贪心算法 |
| 636 | 函数的独占时间 | [ExclusiveTimeFunctions](src/com/leetcode/L601_700/L0636/ExclusiveTimeFunctions.java)
| 中等 | 栈 | 数组、栈 |
...
| 简单 | 模拟 | 数组 |
| 870 | 优势洗牌 | [AdvantageShuffle](src/com/leetcode/L801_900/L0870/AdvantageShuffle.java)
| 中等 | 排序 | 数组、排序、双指针、贪心算法 |
...
| 简单 | 暴力法、Map映射 | 数组、哈希表 |
| 1403 | 非递增顺序的最小子序列
| [MinSubNonOrder](src/com/leetcode/L1401_1500/L1403/MinSubNonOrder.java)
| 简单 | 排序 | 数组、排序、贪心算法 |
| 1418 | 点菜展示表
...
| 简单 | 排序 | 数组、排序 |
| 1636 | 按照频率将数组升序排序
| [SortArrayIncreasingFrequency](src/com/leetcode/L1601_1700/L1636/SortArrayIncreasingFrequency.java)
| 简单 | map映射 | 数组、哈希表、排序 |
| 1640 | 能否连接形成数组
| [CheckArrayConcatenation](src/com/leetcode/L1601_1700/L1640/CheckArrayConcatenation.java)
| 简单 | map映射 | 数组、哈希表 |
| 1646 | 获取生成数组中的最大值 | [GetMaximumGeneratedArray](src/com/leetcode/L1601_1700/L1646/GetMaximumGeneratedArray.java)
| 简单 | 模拟 | 数组、模拟、动态规划 |
| 1652 | 拆炸弹 | [DefuseBomb](src/com/leetcode/L1601_1700/L1652/DefuseBomb.java)
| 简单 | 模拟 | 数组 |
