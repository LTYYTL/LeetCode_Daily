# LeetCode_Daily
记录自己LeetCode每日刷题之旅（现有**472**道，持续更新中...）
...
|80| 删除有序数组中的重复项 II | [RemoveDuplicatesSortedArrayII](src/com/leetcode/L0080/RemoveDuplicatesSortedArrayII.java) | 中等 | 双指针 | 数组、双指针 |
|81| 搜索旋转排序数组 II | [SearchRotatedSortedArrayII](src/com/leetcode/L0081/SearchRotatedSortedArrayII.java) | 中等 | 二分法 | 数组、二分查找 |
...
|137| 只出现一次的数字II | [SingleNumberII](src/com/leetcode/L0137/SingleNumberII.java) | 中等 | Map映射、位运算 | 数组、位运算 |？
...
|167| 两数之和 II - 输入有序数组 | [TwoSumII](src/com/leetcode/L0167/TwoSumII.java) | 简单 | 双指针 | 数组、双指针、二分查找 |
...
|1480| 一维数组的动态和 | [RunningSumArray](src/com/leetcode/L1480/RunningSumArray.java) | 简单 | 模拟 | 数组、前缀和 |
...
|2016| 增量元素之间的最大差值 | [MaxDifferenceElements](src/com/leetcode/L2016/MaxDifferenceElements.java) | 简单 | 双指针 | -- |
...
|67| 二进制加法 | [AddBinary](src/com/leetcode/L0067/AddBinary.java) | 简单 | 模拟 | 字符串、模拟、数学、位运算 |？
...
|318| 最大单词长度乘积 | [MaximumProductWordLengths](src/com/leetcode/L0318/MaximumProductWordLengths.java) | 中等 | 位运算 | 数组、字符串、位运算 |
...
|1436| 旅行终点站 | [DestinationCity](src/com/leetcode/L1436/DestinationCity.java) | 简单 | set集合 | 字符串、哈希表 |
...
|101| 对称的二叉树 | [SymmetricBinaryTree](src/com/leetcode/L0101/SymmetricBinaryTree.java) | 简单 | 递归 | 树、二叉树、广度优先搜索、深度优先搜索 |
...
|437| 路径总和III | [PathSumIII](src/com/leetcode/L0437/PathSumIII.java) | 中等 | 递归、前缀和 | 树、二叉树、深度优先搜索 |
...
|863| 二叉树中所有距离为 K 的结点 | [AllNodesDistanceKBinaryTree](src/com/leetcode/L0863/AllNodesDistanceKBinaryTree.java) | 中等 | 深度优先搜索 | 树、深度优先搜索、广度优先搜索、二叉树 |
...
|72| 编辑距离 | [EditDistance](src/com/leetcode/L0072/EditDistance.java) | 困难 | 动态规划 | 字符串、动态规划 |
...
|639| 解码方法 II | [DecodeWaysII](src/com/leetcode/L0639/DecodeWaysII.java) | 困难 | 动态规划 | 字符串、动态规划 |
...
|  #   |      题目      |   类名   |  难度  |  方法   |    标签   |
| ---- | ------------- | ------- | ----- | ------ | --------- |
|22| 括号生成 | [GenerateParentheses](src/com/leetcode/L0022/GenerateParentheses.java) | 中等 | 回溯算法 | 字符串、回溯算法、动态规划 |
...
|79| 单词搜索 | [WordSearch](src/com/leetcode/L0079/WordSearch.java) | 中等 | 回溯算法 | 数组、回溯算法 |
|90| 子集II | [SubsetsII](src/com/leetcode/L0090/SubsetsII.java) | 中等 | 回溯算法 | 数组、回溯算法 |
|212| 单词搜索 II | [WordSearchII](src/com/leetcode/L0212/WordSearchII.java) | 困难  | 字典树+回溯算法 | 数组、字符串、字典树、回溯算法、矩阵 |
...
|517| 超级洗衣机 | [SuperWashingMachines](src/com/leetcode/L0517/SuperWashingMachines.java) | 困难 | 贪心算法 | 数组、贪心算法 |
...
|223| 矩形面积 | [RectangleArea](src/com/leetcode/L0223/RectangleArea.java) | 中等 | 数学 | 数学、几何 |
...
|400| 第 N 位数字 | [DigitSequenceNumbers](src/com/leetcode/L0400/DigitSequenceNumbers.java) | 中等 | 数学 | 数学、二分查找 |
...
|07| 重建二叉树 | [RebuildBinaryTree](src/com/offer/L0007/RebuildBinaryTree.java) | 中等 | 递归 | 树、数组、二叉树、哈希表、分治 |
...
|14-II| 剪绳子-II | [CutRopeII](src/com/offer/L0142/CutRopeII.java) | 中等 | 贪心算法  | 数学、动态规划 |
|15| 二进制中1的个数 | [NumberOneBits](src/com/offer/L0150/NumberOneBits.java) | 简单 | 位运算 | 位运算 |
|17| 打印从1到最大的n位数 | [PrintLargestNDigits](src/com/offer/L0170/PrintLargestNDigits.java) | 简单 | 数学 | 数组、数学 |
|18| 删除链表的节点 | [DeleteNodeList](src/com/offer/L0180/DeleteNodeList.java) | 简单 | 双指针 | 链表 |
|19| 正则表达式匹配 | [RegularExpressionMatching](src/com/offer/L0190/RegularExpressionMatching.java) | 困难 | 动态规划 | 字符串、动态规划、递归 |
...
|33| 二叉搜索树的后序遍历序列 | [BSTPostOrder](src/com/offer/L0330/BSTPostOrder.java) | 中等 | 递归、单调栈 | 树、二叉树、二叉搜索树、栈、单调栈、递归 |
...
|43| 1～n 整数中 1 出现的次数 | [NumberDigitOne](src/com/offer/L0430/NumberDigitOne.java) | 困难 | 数学 | 数学、递归、动态规划 |
|44| 数字序列中某一位的数字 | [DigitSequenceNumbers](src/com/offer/L0440/DigitSequenceNumbers.java) | 中等 | 数学 | 数学、二分查找 |
...
|51| 数组中的逆序对 | [ReversedPairsArray](src/com/offer/L0510/ReversedPairsArray.java) | 困难 | 归并排序 | 数组、线段树、树状数组、有序集合、二分查找、分治、归并排序 |
...
|60| n个骰子的点数 | [NDicePoints](src/com/offer/L0600/NDicePoints.java) | 中等 | 动态规划 | 数学、动态规划、概率与统计 |
...
|005| 单词长度最大乘积 | [MaximumProductWordLengths](src/com/offerII/L005/MaximumProductWordLengths.java) | 中等 | 位运算 | 数组、字符串、位运算 |
|006| 排序数组中两个数字之和 | [TwoSumII](src/com/offerII/L006/TwoSumII.java) | 简单 | 双指针 | 数组、双指针、二分查找 |
